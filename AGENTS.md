...
Prompt-oriented files intended for direct paste into agent or custom-instruction surfaces should be stored as paste-ready Markdown snippets in the same format as [POLICIES.prompt.md](./POLICIES.prompt.md).
...
- [POLICIES.prompt.md](./POLICIES.prompt.md): base code and deployment policy stored in the repository's prompt-ready format for agent instructions and custom instruction surfaces.
